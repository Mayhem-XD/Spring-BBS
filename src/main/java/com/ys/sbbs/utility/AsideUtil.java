...
//			응답 결과 확인
			...
			System.out.println(localItem.get("x"));
			System.out.println(localItem.get("y"));
...
//	OpenWeather API
	public String getWeather(String lng, String lat) {
		String apiUrl = "http://api.openweathermap.org/data/2.5/weather";
		apiUrl += "?lat="+lat+"&lon="+lat+"&appid="+openWeatherApiKey+"&units=metric&lang=kr";
		...
		try {
			...
			weatherStr = "<img src=\""+iconUrl+"\" height=\"28\">"+desc+" 온도: <strong>"+tempStr+"</strong>&#8451";
